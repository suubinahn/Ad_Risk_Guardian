...
주요 코드 경로: **pipeline/text**

주요 수행 내용은 다음과 같습니다.

- 식품 광고 텍스트 데이터셋이 존재하지 않아 **식품 광고 문장 약 2,000건을 직접 수집**
...
※ 일부 Jupyter Notebook 파일은 GitHub 환경에서 정상적으로 렌더링되지 않을 수 있습니다.  
필요 시 파일을 다운로드하여 실행하면 전체 내용을 확인할 수 있습니다.
